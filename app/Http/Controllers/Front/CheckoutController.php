...
/*============================ cash on delivry        ==================================*/
     ...
     //   $order['order_number'] = str_random(4).time();
       ...
       // $order['customer_zip'] = $request->zip;
        ...
        //                      $usrrid = Auth::guard('web')->user()->id;
        //                   $userrdta = AffilateUsers::where('product_id',$prod['item']['id'])->where('user_id',$usrrid)->first(); 
        ...
        //                     if(!empty($pdata->affiliate_setting_id) || $pdata->affiliate_setting_id != 'NUll' ) {
                                   
        //                               $affdata =  AffiliateSetting::where('id',$pdata->affiliate_setting_id)->first(); 
        ...
        //                                     $user->affilate_income += $affdata->amount;
        //                                     $user->update();
        //                                     $order['affilate_user'] = $user->name;
     ...
     /*   $data = [
            ...
            'aemail' => $order->customer_email,
            'wtitle' => "Your Order Placed!!",
            ...
            Session::forget('coupon_pro');
                          ...
                          $tokken= array(
                           ...
                           "api_key"=> $gs->accept_key,
                             ...
                             $responses= $client->post('https://accept.paymobsolutions.com/api/auth/tokens',
            ...
            Session::forget('coupon_pro');
                           ...
                           $payy['metadata']=array(
	                        	...
	                        	'email'=>$order->customer_email
                                     ...
                                     $response = $client->post("$gs->thawani_link/api/v1/checkout/session",
            ...
            Session::forget('coupon_pro');
                                ...
                                $client = new Client([
                                  'headers' => ['Content-Type' =>'application/json']
                                    ...
                                    $response = $client->post('https://maktapp.credit/v3/AddTransaction',
                            ...
                            $payy = array(
                               ...
                               "merchant_reference"=> $pay_ref,
              	                ...
              	                "skip"=>"1",
                                     ...
                                     $response = $client->post('https://thirdparty.thawani.om/api/TransactionHistory/',
