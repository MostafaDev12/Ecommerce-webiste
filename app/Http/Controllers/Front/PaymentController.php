...
class PaymentController extends Controller
{
   ...
   public function bankmasr(){
      ...
      public function Nbe_Payment(){
        ...
        $order = Session::get('temporder');
          ...
          $response = $client->post('https://nbe.gateway.mastercard.com/api/rest/version/57/merchant/'.$merchantid.'/session',
 ...
 public function vapulus()
   ...
   public function getbankmasrapi(){
       ...
       $response = $client->post('https://banquemisr.gateway.mastercard.com/api/rest/version/56/merchant/{{$gs->merchant_id}}/session',
