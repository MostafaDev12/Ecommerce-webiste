...
class CouponController extends Controller
{
  ...
  public function indexpro($id)
    ...
    public function edit($id)
    {
        ...
        return view('admin.coupon.edit',compact('data','users','cats','subcats','childcats','brands','pro'));
    }
    ...
    public function datatablesPiece()
    {
         ...
         return Datatables::of($datas) ->editColumn('user_id', function(Piece $data) {
                            ...
                            ->addColumn('action', function(Piece $data) {
                                ...
                                <a data-href="' . route('admin-coupon-edit-piece',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a>
                                <a href="' . route('admin-coupon-pro-piece',$data->id) . '" class="edit" > <i class="fas fa-edit"></i>Products</a>
                                <a href="javascript:;" data-href="' . route('admin-coupon-delete-piece',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>
    ...
    public function datatablesfree()
    {
         ...
         return Datatables::of($datas) ->editColumn('user_id', function(Free $data) {
                            ...
                            ->addColumn('action', function(Free $data) {
                                return '<div class="action-list">
                                <a data-href="' . route('admin-coupon-edit-free',$data->id) . '" class="edit" data-toggle="modal" data-target="#modal1"> <i class="fas fa-edit"></i>Edit</a>
                                <a href="' . route('admin-coupon-pro-free',$data->id) . '" class="edit" > <i class="fas fa-edit"></i>Products</a>
                                <a href="javascript:;" data-href="' . route('admin-coupon-delete-free',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>
