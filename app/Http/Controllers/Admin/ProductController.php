         ...
         return Datatables::of($datas)
                            ...
                            ->editColumn('price', function(Product $data) {
                                ...
                                return  $price;
                                   ...
                                   $link =   url('assets/images/thumbnails',$data->thumbnail) ;
    ...
    public function edit($id)
    {
       $colors = Color::where('product_id',$id)->get();
        ...
        if($data->type == 'Digital')
            ...
            return view('admin.product.edit.digital',compact('cats','data','sign','pro','Related','colors','brands','affilates'));
        elseif($data->type == 'License')
            return view('admin.product.edit.license',compact('cats','data','sign','pro','Related','colors','brands','affilates'));
        else
           
            return view('admin.product.edit.physical',compact('cats','data','sign','pro','Related','colors','brands','affilates'));
    } 
