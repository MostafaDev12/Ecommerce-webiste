    ...
    public function datatables($type)
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Banner $data) {
                                ...
                                <a href="javascript:;" data-href="' . route('admin-sb-delete',$data->id) . '" data-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
