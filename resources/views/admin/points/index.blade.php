                        ...
                        @include('includes.admin.form-success')  
										...
										<div class="table-responsiv">
										       <div class="col-sm-12 table-contents">
                                                <a class="add-btn" data-href="{{route('admin-pointss-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="mr-table allproduct default-box">
										...
										<div class="table-responsiv">
										     <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-pointss-piece-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="mr-table allproduct default-box">
										...
										<div class="table-responsiv">
										     <div class="col-sm-12 table-contents">
                                                    	<a class="add-btn" data-href="{{route('admin-pointss-free-create')}}" id="add-data" data-bs-toggle="modal" data-bs-target="#modal1">
