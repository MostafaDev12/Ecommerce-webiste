                     	...
                     	<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="50%">
													...
													<tbody>
													    ...
													    <td>
													                                                                     <a href="javascript:;" data-href="{{route('admin-offer-product-delete',$d->id)}}" data-bs-toggle="modal" data-bs-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a>
