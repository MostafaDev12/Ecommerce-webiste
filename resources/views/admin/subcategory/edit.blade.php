...
<form id="geniusformdata" action="{{route('admin-subcat-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="inp-50">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="title" placeholder="English Title"  value="{{$data->title}}">
        </div>
        <div class="col-md-6">
            <label>Arabic Title</label>
            <input type="text" class="form-control" name="title_ar" placeholder="Arabic Title"  value="{{$data->title_ar}}">
        </div>
    </div> 
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="text-editor">
                ...
                <textarea name="meta_description" class="ckeditor form-control" placeholder="English Meta Description">{{ $data->meta_description }}</textarea>
            </div>
        </div>
        <div class="col-md-6">
            <div class="text-editor">
                <label>Arabic Meta Description</label>
                <textarea name="meta_description_ar" class="ckeditor form-control" placeholder="Arabic Meta Description">{{ $data->meta_description_ar }}</textarea>
            </div>
        </div>
    </div>
    <div class="row">
