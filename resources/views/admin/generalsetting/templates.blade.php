...
<div class="content-area">
    <div class="home-head mb-4 mb-md-5">
        <h3>Template Settings <span>Manage your template settings</span></h3>
        <nav class="mt-3" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }}</a></li>
                <li class="breadcrumb-item"><a href="{{ url('admin/main-settings') }}">Main Settings</a></li>
                <li class="breadcrumb-item"><a href="{{ url('admin/general-settings') }}">General Settings</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Free Template</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 mb-4">
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 1-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 2-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 5-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 6-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 11-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 15-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 mb-4">
                        <div class="template-box text-center position-relative">
                            ...
                            <img src="{{asset('assets/admin/images/template-images/template.webp')}}" class="w-100">
                            <div class="template-info mt-3">
                                <h4 class="mb-2">Template 16-New</h4>
                                <p>Main settings for your store</p>
                            </div>
                        </div>
                    </div>
