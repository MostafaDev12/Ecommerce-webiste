...
<div class="content-area">
	<div class="home-head mb-4 mb-md-5">
        <h3>{{ __("Products") }} <span>Manage your products</span></h3>
						...
						<div class="row table-footer-btns mt-4">
							<div class="col-lg-12" style="display:contents">
								...
								<form  action="{{route('export-products')}}" method="post" style="margin-right: 5px;">
								     {{csrf_field()}}
								    <button class="main-light-btn">Export All</button>
								</form>
								<div class="">
								  <button  class="feature main-light-btn" id="feature-selected" data-bs-toggle="modal" data-bs-target="#modal3"> <i class="fas fa-star"></i> Highlight</button>     
								</div>
						    </div>
					    </div>
				    </div>
