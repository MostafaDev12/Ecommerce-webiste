...
<div class="content-area">
    <div class="home-head mb-4">
        <h3>{{ __('Physical Product') }} <span>Manage your physical products</span></h3>
			...
			<div class="col-lg-12">
				<div class="product-description">
					<div class="body-area" style="background: #f2f3f8;padding: 0">
                        ...
                        <form id="geniusform" action="{{route('admin-prod-store')}}" class="exp-form" method="POST" enctype="multipart/form-data">
	                        {{csrf_field()}}
                            ...
                            <div class="default-box">
                                <div class="row mb-0">
                                                ...
                                                <div class="row">
    												<div class="col-lg-12">
    												    <div class="form-group">
    														...
    														<div class="text-editor">
    														    <textarea class="ckeditor form-control" name="policy_ar">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Feature Image') }} * <small>image size 205px X 205px</small></label>
                                       ...
                                       <!-- 		<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1 mt-1 mb-2">-->
        							    ...
        							    <div class="row">
    				                        <div class="col-lg-12">
                                                <div class="form-group">
        											<label>{{ __('Product Gallery Images') }} * <small>{{ __('You can upload multiple Images.') }} - image size 205px X 205px</small></label>
        								...
        								<div class="row">
    				                        <div class="col-lg-12">
                                                <div class="form-group">
    												<label>{{ __('Product Mobile Gallery Images') }} * <small>{{ __('You can upload multiple Images.') }} - image size 205px X 205px</small></label>
            										<a href="#" class="set-gallery-prod set-gallery-mobile"  data-bs-toggle="modal" data-bs-target="#setgallerymobile">
        										...
        										<div class="col-lg-6">
        											<div class="form-group">
        												...
        												<select id="affiliate_setting_id" name="affiliate_setting_id" class="form-control">
                                                            ...
                                                            <option value="{{$affilate->id}}">{{$affilate->affiliate_name}}</option>
                                                            @endforeach
                                                        </select>
        											</div>
        										</div>
                                            ...
                                            <div class="row">
        										...
        										<div class="col-lg-6">
        											<div class="form-group">
        												...
        												<input name="mobile_price" type="number" class="form-control" placeholder="{{ __('e.g 20') }}" step="0.1"  min="0" value="0">
        											</div>
        										</div>
        										<div class="col-lg-6" id="stckprod">
        											<div class="form-group">
        												<label class="heading">{{ __('Product Stock') }}* <small>{{ __('(Leave Empty will Show Always Available)') }}</small></label>
