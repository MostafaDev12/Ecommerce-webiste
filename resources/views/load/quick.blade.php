...
<div class="right-area">
  <div class="product-info">
      <h4 class="product-name"><a target="_blank" href="{{ route('front.product',['slug' => $product->slug , 'lang' => $sign]) }}">{{ $product->name }}</a></h4>
      ...
      @if(!empty($product->size))
          <div class="product-size">
              ...
              <ul class="siz-list siz-lists">
                  @php
                   $co = App\Models\Color::where('product_id',$product->id)->where('size',$product->size[0])->where('size_qty','>', 0)->get();
                      $is_first = true;
                  @endphp
   ...
   @elseif(!empty($colors))
        ...
        <div class="product-size">
                    ...
                    <ul class="siz-list siz-list2">
                      @php
                      $co = App\Models\Color::where('product_id',$product->id)->where('size',$colors->size)->where('size_qty','>', 0)->get();
                      $is_first = true;
                      @endphp
