...
@if(!$slang)
          ...
          @endif
											...
											<div class="item-img">
												...
												<img class="img-fluid" style="height:378px" src="{{ $prod->photo ? filter_var($prod->photo, FILTER_VALIDATE_URL) ? $prod->photo :asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}" alt="">
											</div>
											<div class="info">
												<div class="stars">
                            <div class="ratings">
          ...
          @endif</h5>
														<div class="item-cart-area">
															...
															@else
																...
																@else
																<span class="add-to-cart add-to-cart-btn  addcrt" data-href="{{ route('product.cart.add',$prod->id) }}">
