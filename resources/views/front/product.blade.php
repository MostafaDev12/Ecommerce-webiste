    ...
    <div class="col-lg-9">
        <div class="row">
          ...
          <div class="xzoom-container">
              <a href="{{filter_var($productt->photo, FILTER_VALIDATE_URL) ?$productt->photo:asset('assets/images/products/'.$productt->photo)}}" data-lightbox="lightbox">
              ...
              <div class="xzoom-thumbs">
                ...
                <a href="{{filter_var($gal->photo, FILTER_VALIDATE_URL) ? $gal->photo : asset('assets/images/galleries/'.$gal->photo)}}" data-lightbox="lightbox">
                    <!--<a href="{{asset('assets/images/galleries/'.$gal->photo)}}">-->
                  <img class="xzoom-gallery5" width="80" src="{{filter_var($gal->photo, FILTER_VALIDATE_URL) ? $gal->photo :asset('assets/images/galleries/'.$gal->photo)}}" title="The description goes here"
                 ...
                 <div class="product-size">
                  ...
                  <div class="info-meta-3">
                    <ul class="meta-list">
                      ...
                      <li class="addtocart">
                        <a href="{{ route('affiliate.product', ['slug' => $productt->slug , 'lang' => $sign ]) }}" target="_blank"><i
                      ...
                      <li class="addtocart " >
                        <a href="{{ route('product.cart.quickadd',['id' => $productt->id , 'lang' => $sign]) }}"><i
                            class="icofont-cart"></i>{{ $langg->lang251 }}</a>
                      </li>
                      @endif
...
<div class="seller-info mt-3">
        <div class="content">
             @if(!$slang)
              @if($lang->id == 2)
          <a  href="{{url('brand/'.$productt->brand->slug_ar)}}" ><img   src="{{asset('assets/images/brands/'.$productt->brand->photo)}}"/></a>
              @else 
             <a  href="{{url('brand/'.$productt->brand->slug)}}" ><img   src="{{asset('assets/images/brands/'.$productt->brand->photo)}}"/></a>
              @endif 
          @else  
              @if($slang == 2) 
           <a  href="{{url('brand/'.$productt->brand->slug_ar)}}" ><img   src="{{asset('assets/images/brands/'.$productt->brand->photo)}}"/></a>
