...
<main class="main">
			...
			<div class="promo-section mb-5" data-parallax="{'speed': 1.5}" data-image-src="{{('assets/images/banners/'.$fix_banners[0]->photo)}}">
				<div class="promo-content">
					<h2 class="m-b-1">@if(!$slang)
                                          @if($lang->id == 2)
					...
					<h3>@if(!$slang)
                                          ...
                                          @endif</h3>
					<hr class="divider-short-thick">
					<a href="{{$fix_banners[0]->link}}" class="btn btn-light ls-n-25">@if(!$slang)
                                           @if($lang->id == 2)
