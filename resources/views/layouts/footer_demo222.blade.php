...
@if(isset($visited))
    ...
    <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background-image: url({{asset('assets/images/'.$gs->popup_background)}}) ;background-repeat: round;">
        <div class="newsletter-popup-content">
            <img src="{{asset('assets/images/'.$gs->logo)}}" alt="Logo" class="logo-newsletter" style="width:50%">
            <h2 style="color: white;">{{$gs->popup_title}}</h2>
            <p style="color: white;">{{$gs->popup_text}}</p>
            <form action="{{route('front.subscribe')}}" id="subscribeform" method="POST">
...
<script src="{{asset('assets/front/js/popper.min.js')}}"></script>
    ...
    <script src="{{asset('assets/demo_222/assets/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets/demo_222/assets/js/plugins.min.js')}}"></script>
